        ...
        if (seatArray) {
            ...
            return (< div > < hr className='hr3' /> < p > {
                ...
                const {
                    ...
                    return(< div className='paym' > < div className='row' > < div key='Payment' > < div className='App-payment cl-1' > < p className='pPayment' > Enter Credit card details < /p>{' '} <
                        Card number={number}
                        name={name}
                        expiry={expiry}
                        cvc={cvc}
                    ...
                    /> {
                            ' '
                        } < form className='credit-form' ref={
                            c => (this.form = c)
                        }
                            onSubmit={
                                this.handleSubmit
                            } > < div className='form-group' > < input type='tel' name='number' className='frm-ctrl' placeholder='Card Number' pattern='[\d| ]{16,22}' required onChange={
            ...
            div className='form-group' >
                                            ...
                                            /> {
                                                ...
                                                e => this.moveToTicketPage(e)
                                            }
                                                className='btn btn-light btCustom' > PAY {
                                                    ' '
                                                } < /button>{' '} <
            /div > {
                                                    ' '
